...
class IndividualHajjWidget extends StatelessWidget {
  int index;
   String title;
   IndividualHajjWidget({super.key,required this.index,required this.title});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap:(){
         hajjController.changeIndexManask(index);
        if(index==0)
        ...
        child: Row(
          ...
          children: [
            ...
            Padding(
              ...
              child: Image.asset(
                                   width:30.w,
                  index==1||index==12||index==2||index==3||index==14||index==5?
                 ...
                 "assets/images/individual/im_${index-2}.png"),
            )
          ],
        ),
