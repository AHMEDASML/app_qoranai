...
import 'package:Al_Arqam/view/hajj_rituals/widgets/shaving_trimming/mistakes_shaving_trimming_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/shaving_trimming/text_shaving_tomatoa_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/shaving_trimming/text_shaving_trimming_widget.dart';
...
class ShavingTrimmingScreen extends StatefulWidget {
  bool? flag;
  ShavingTrimmingScreen({super.key, this.flag});

  HajjRitualsController hajjController = Get.find<HajjRitualsController>();

  @override
  State<ShavingTrimmingScreen> createState() => _ShavingTrimmingScreenState();
}

class _ShavingTrimmingScreenState extends State<ShavingTrimmingScreen> {
  @override
                            ...
                            child: SingleChildScrollView(
                              child: Container(
                                ...
                                child: hajjController.selectedTab.value == HajjRitualsEnum.text
                                    ?widget.flag==null? const TextShavingTrimmingWidget():TextShavingTomatoaWidget()
                                    : const MistakesShavingTrimmingWidget(),
                              ),
                            ),
                          ),
                        ],
