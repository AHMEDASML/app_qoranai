...
import 'package:Al_Arqam/view/hajj_rituals/widgets/between_safa_and_marwah/dwa_between_safa_and_marwah_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/between_safa_and_marwah/mistakes_between_safa_and_marwah_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/between_safa_and_marwah/text_between_safa_and_marwah_widget.dart';
...
class BetweenSafaAndMarwahScreen extends StatefulWidget {
  BetweenSafaAndMarwahScreen({super.key});

  HajjRitualsController hajjController = Get.find<HajjRitualsController>();

  @override
  State<BetweenSafaAndMarwahScreen> createState() => _BetweenSafaAndMarwahScreenState();
}

class _BetweenSafaAndMarwahScreenState extends State<BetweenSafaAndMarwahScreen> {
  @override
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.fill,
                                    image: AssetImage("assets/images/safaa3.jpeg"),
                                  ),
                                ),
                              ),
                            ...
                            child: SingleChildScrollView(
                              child: Container(
                                ...
                                child: hajjController.selectedalqdomTab.value == twaffAlqdomEnum.mistakes
                                    ? const MistakesBetweenSafaAndMarwahWidget()
                                    : hajjController.selectedalqdomTab.value == twaffAlqdomEnum.dwaa
                                        ? const DwaBetweenSafaAndMarwahWidget()
                                        : TextBetweenSafaAndMarwahWidget(),
                              ),
                            ),
                          ),
                        ],
