...
class WaterZamzamScreen extends StatefulWidget {
  WaterZamzamScreen({super.key});


  @override
  State<WaterZamzamScreen> createState() => _WaterZamzamScreenState();
}

  HajjRitualsController hajjController = Get.find<HajjRitualsController>();
class _WaterZamzamScreenState extends State<WaterZamzamScreen> {
  @override
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.cover ,
                                    image: AssetImage("assets/images/zam.jpeg"),
                                  ),
                                ),
                              ),
                            ...
                            child: SingleChildScrollView(
                              child: Container(
                                ...
                                child: hajjController.selectedTab.value == HajjRitualsEnum.text
                                    ? TextWaterZamzamWidget()
                                    : MistakesWaterZamzamWidget(),
                              ),
                            ),
                          ),
