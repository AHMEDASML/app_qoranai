...
class ComingToMinaScreen extends StatefulWidget {
  ComingToMinaScreen({super.key});

  HajjRitualsController hajjController = Get.find<HajjRitualsController>();

  @override
  State<ComingToMinaScreen> createState() => _ComingToMinaScreenState();
}

class _ComingToMinaScreenState extends State<ComingToMinaScreen> {
  @override
                            ...
                            child: SingleChildScrollView(
                              child: Container(
                                ...
                                child: hajjController.selectedTab.value == HajjRitualsEnum.text
                                    ? TextComingToMinaWidget()
                                    : MistakesComingToMinaWidget(),
                              ),
                            ),
                          ),
                        ],
