...
class TamtaoHajjScreen extends StatefulWidget {
  const TamtaoHajjScreen({super.key});
  
  @override
  State<TamtaoHajjScreen> createState() => _TamtaoHajjScreenState();
}

class _TamtaoHajjScreenState extends State<TamtaoHajjScreen> {
                            ...
                            return Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  TomatoHajjWidget(index: index, title: individuals[index]),
                                ],
                              ),
                            );
                          },
