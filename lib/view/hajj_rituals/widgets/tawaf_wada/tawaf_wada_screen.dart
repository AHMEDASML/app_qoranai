...
import 'package:Al_Arqam/view/hajj_rituals/widgets/tawaf_wada/mistakes_tawaf_wada_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/tawaf_wada/text_tawaf_wada_widget.dart';
...
class TawafWadaScreen extends StatefulWidget {
  TawafWadaScreen({super.key});

  HajjRitualsController hajjController = Get.find<HajjRitualsController>();

  @override
  State<TawafWadaScreen> createState() => _TawafWadaScreenState();
}

class _TawafWadaScreenState extends State<TawafWadaScreen> {
  @override
                            ...
                            child: SingleChildScrollView(
                              child: Container(
                                ...
                                child: hajjController.selectedTab.value == HajjRitualsEnum.text
                                    ? const TextTawafWadaWidget()
                                    : const MistakesTawafWadaWidget(),
                              ),
                            ),
                          ),
                        ],
