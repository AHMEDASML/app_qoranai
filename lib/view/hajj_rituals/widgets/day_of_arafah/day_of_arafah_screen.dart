...
import 'package:Al_Arqam/view/hajj_rituals/widgets/day_of_arafah/mistakes_day_of_arafah_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/day_of_arafah/text_day_of_arafah_widget.dart';
...
class DayOfArafahScreen extends StatefulWidget {
  DayOfArafahScreen({super.key});

  HajjRitualsController hajjController = Get.find<HajjRitualsController>();

  @override
  State<DayOfArafahScreen> createState() => _DayOfArafahScreenState();
}

class _DayOfArafahScreenState extends State<DayOfArafahScreen> {
  @override
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.cover ,
                                    image: AssetImage("assets/images/arafah.jpeg"),
                                  ),
                                ),
                              ),
                            ...
                            child: SingleChildScrollView(
                              child: Container(
                                ...
                                child: hajjController.selectedTab.value == HajjRitualsEnum.text
                                    ? TextDayOfArafahWidget()
                                    : MistakesDayOfArafahWidget(),
                              ),
                            ),
                          ),
                        ],
