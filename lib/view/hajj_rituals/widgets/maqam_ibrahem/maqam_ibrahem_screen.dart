...
import 'package:Al_Arqam/view/hajj_rituals/widgets/maqam_ibrahem/mistakes_maqam_ibrahem_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/maqam_ibrahem/text_maqam_ibrahem_widget.dart';
import 'package:Al_Arqam/view/main_controller.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class MaqamIbrahemScreen extends StatefulWidget {
  MaqamIbrahemScreen({super.key});

 

  @override
  State<MaqamIbrahemScreen> createState() => _MaqamIbrahemScreenState();
}

 HajjRitualsController hajjController = Get.find<HajjRitualsController>();
class _MaqamIbrahemScreenState extends State<MaqamIbrahemScreen> {
  @override
 ...
 Navigator.of(context).pushNamed(AppRoutesPath.AmraaRitualsScreen);
              ...
              title: hajjController.selectedTabHajj.value == HajjEnum.umrah?
                   'rituals_of_umrah'.tr:
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: AssetImage("assets/images/maqam.jpeg"),
                                  ),
                                ),
                              ),
                            ...
                            child: SingleChildScrollView(
                              child: Container(
                                ...
                                child: hajjController.selectedTab.value == HajjRitualsEnum.text
                                    ? TextMaqamIbrahemWidget()
                                    : MistakesMaqamIbrahemWidget(),
                              ),
                            ),
                          ),
                        ],
