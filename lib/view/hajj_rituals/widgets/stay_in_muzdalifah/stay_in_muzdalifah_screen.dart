...
class StayInMuzdalifahScreen extends StatefulWidget {
  StayInMuzdalifahScreen({super.key});

  HajjRitualsController hajjController = Get.find<HajjRitualsController>();

  @override
  State<StayInMuzdalifahScreen> createState() => _StayInMuzdalifahScreenState();
}

class _StayInMuzdalifahScreenState extends State<StayInMuzdalifahScreen> {
  @override
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.cover ,
                                    image: AssetImage("assets/images/muzdalifah.jpeg"),
                                  ),
                                ),
                              ),
                            ...
                            child: SingleChildScrollView(
                              child: Container(
                                ...
                                child: hajjController.selectedTab.value == HajjRitualsEnum.text
                                    ? TextStayInMuzdalifahWidget()
                                    : MistakesStayInMuzdalifahWidget(),
                              ),
                            ),
                          ),
                        ],
