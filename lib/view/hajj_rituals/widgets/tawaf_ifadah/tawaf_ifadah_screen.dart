...
import 'package:Al_Arqam/view/hajj_rituals/widgets/tawaf_ifadah/text_tawaf_ifadah_widget.dart';
...
class TawafIfadahScreen extends StatefulWidget {
  TawafIfadahScreen({super.key});

  HajjRitualsController hajjController = Get.find<HajjRitualsController>();

  @override
  State<TawafIfadahScreen> createState() => _TawafIfadahScreenState();
}

class _TawafIfadahScreenState extends State<TawafIfadahScreen> {
  @override
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.cover ,
                                    image: AssetImage("assets/images/ifadah.jpeg"),
                                  ),
                                ),
                              ),
                          ...
                          Expanded(
                            child: SingleChildScrollView(
                              child: Container(
                                ...
                                child:  const TextTawafIfadahWidget()
