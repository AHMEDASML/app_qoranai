...
import 'package:Al_Arqam/view/hajj_rituals/widgets/stay_in_muzdalifah/mistakes_stay_in_muzdalifah_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/stay_in_muzdalifah/text_stay_in_muzdalifah_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/throwing_the_jamrat/mistakes_throwing_the_jamrat_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/throwing_the_jamrat/text_throwing_the_jamrat_widget.dart';
...
class ThrowingTheJamratScreen extends StatefulWidget {
  ThrowingTheJamratScreen({super.key});

  HajjRitualsController hajjController = Get.find<HajjRitualsController>();

  @override
  State<ThrowingTheJamratScreen> createState() => _ThrowingTheJamratScreenState();
}

class _ThrowingTheJamratScreenState extends State<ThrowingTheJamratScreen> {
  @override
 ...
 Navigator.of(context).pushNamed(AppRoutesPath.AmraaRitualsScreen);
              ...
              subTitle:GlobalFunctions.getLangCode()=='en'? 'throwing_jamrat_al_aqabah'.tr.substring(0,28): 'throwing_jamrat_al_aqabah'.tr,
              isManask:true,
                              ...
                              Container(
                                ...
                                decoration: const BoxDecoration(
                                  image: DecorationImage(
                                    fit: BoxFit.cover ,
                                    image: AssetImage("assets/images/jamrat.jpeg"),
                                  ),
                                ),
                              ),
                            ...
                            child: SingleChildScrollView(
                              child: Container(
                                ...
                                child: hajjController.selectedTab.value == HajjRitualsEnum.text
                                    ? TextThrowingTheJamratWidget()
                                    : MistakesThrowingTheJamratWidget(),
                              ),
                            ),
                          ),
                        ],
