...
import 'package:Al_Arqam/view/hajj_rituals/widgets/slaughtering_hadi/mistakes_slaughtering_hadi_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/slaughtering_hadi/text_slaughtering_hadi_quran_widget.dart';
import 'package:Al_Arqam/view/hajj_rituals/widgets/slaughtering_hadi/text_slaughtering_hadi_widget.dart';
...
class SlaughteringHadiScreen extends StatefulWidget {
  SlaughteringHadiScreen({super.key});

  HajjRitualsController hajjController = Get.find<HajjRitualsController>();

  @override
  State<SlaughteringHadiScreen> createState() => _SlaughteringHadiScreenState();
}

class _SlaughteringHadiScreenState extends State<SlaughteringHadiScreen> {
  @override
                              ...
                              child: Container(
                                ...
                                child: hajjController.selectedTab.value == HajjRitualsEnum.text
                                    ?hajjController.selectedTabHajj.value == HajjEnum.person? 
                                     const TextSlaughteringHadiWidget():
                                     const TextSlaughteringHadiQuranWidget()
                                    : const MistakesSlaughteringHadiWidget(),
                              ),
                            ),
                          ),
                        ],
